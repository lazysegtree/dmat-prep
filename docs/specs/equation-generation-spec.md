...
Mock questions are sampled without repeats and shuffled. The selected mock level is preserved in the URL, saved results, progress history, repeat attempts, and backups. Historical mocks without a level are displayed as Normal.
